...
public:
	...
	/* Refine																*/ 
	void				refine(ImplicitFn* ifn,btScalar accurary,bool cut,btVector3& impact);
	void				refine2(ImplicitFn* ifn,btScalar accurary,bool cut,btVector3& impact);
	void                startpos(btVector3& impact);
	btScalar			cal_m(Node& a,Node& b,btScalar t,Node& impact);
	/* CutLink																*/ 
